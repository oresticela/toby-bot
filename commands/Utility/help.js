...
module.exports = {
    ...
    async run (client, message, args){
        ...
        .setTitle('FAQ')
        .addField('`How to use commands`', 'to use a command, type >[command name]')
        ...
        .addField('`Who is the bot dev`', 'ShadowHunters is the owner of this bot, 852954178212200470 <= ID')
        .addField('`How do i report a bug`', 'It is simple, just message the bug to this ID => 852954178212200470')
        .setColor('RANDOM')
        .setTimestamp()
